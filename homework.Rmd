...
assignment_links_html <- sapply(lapply(assignment_links, function(x) {
  if(length(x)>1) {
    tmp1 <- paste0("[",
                   as.character(fontawesome::fa("file-alt", height = "3em", fill = "#2fa4e7")),
                   " (", 1:length(x), ")](")
    } else {
      tmp1 <- paste0("[",
                     as.character(fontawesome::fa("file-alt", height = "3em", fill = "#2fa4e7")),
...
template_links_html <- sapply(lapply(template_links, function(x) {
  if(length(x)>1) {
    tmp1 <- paste0("[",
                   as.character(fontawesome::fa("file-code", height = "3em", fill = "#2fa4e7")),
                   " (", 1:length(x), ")](")
    } else {
      tmp1 <- paste0("[",
                     as.character(fontawesome::fa("file-code", height = "3em", fill = "#2fa4e7")),
...
data_links_html <- sapply(lapply(data_links, function(x) {
  if(length(x)>1) {
    tmp1 <- paste0("[",
                   as.character(fontawesome::fa("table", height = "3em", fill = "#2fa4e7")),
                   " (", 1:length(x), ")](")
    } else {
      tmp1 <- paste0("[",
                     as.character(fontawesome::fa("table", height = "3em", fill = "#2fa4e7")),
...
key_links_html <- sapply(lapply(key_links, function(x) {
  if(length(x)>1) {
    tmp1 <- paste0("[",
                   as.character(fontawesome::fa("key", height = "3em", fill = "#2fa4e7")),
                   " (", 1:length(x), ")](")
    } else {
      tmp1 <- paste0("[",
                     as.character(fontawesome::fa("key", height = "3em", fill = "#2fa4e7")),
