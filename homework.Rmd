...
assignment_links_html <- sapply(lapply(assignment_links, function(x) {
  if(length(x)>1) {
    tmp1 <- paste0("[",
                   as.character(fontawesome::fa("file-alt", height = "5em", fill = "#4582ec")),
                   " (", 1:length(x), ")](")
    } else {
      tmp1 <- paste0("[",
                     as.character(fontawesome::fa("file-alt", height = "5em", fill = "#4582ec")),
...
template_links_html <- sapply(lapply(template_links, function(x) {
  if(length(x)>1) {
    tmp1 <- paste0("[",
                   as.character(fontawesome::fa("file-code", height = "5em", fill = "#4582ec")),
                   " (", 1:length(x), ")](")
    } else {
      tmp1 <- paste0("[",
                     as.character(fontawesome::fa("file-code", height = "5em", fill = "#4582ec")),
...
data_links_html <- sapply(lapply(data_links, function(x) {
  if(length(x)>1) {
    tmp1 <- paste0("[",
                   as.character(fontawesome::fa("table", height = "5em", fill = "#4582ec")),
                   " (", 1:length(x), ")](")
    } else {
      tmp1 <- paste0("[",
                     as.character(fontawesome::fa("table", height = "5em", fill = "#4582ec")),
...
key_links_html <- sapply(lapply(key_links, function(x) {
  if(length(x)>1) {
    tmp1 <- paste0("[",
                   as.character(fontawesome::fa("key", height = "5em", fill = "#4582ec")),
                   " (", 1:length(x), ")](")
    } else {
      tmp1 <- paste0("[",
                     as.character(fontawesome::fa("key", height = "5em", fill = "#4582ec")),
