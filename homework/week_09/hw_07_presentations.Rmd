...
start_date <- as.POSIXct("2024-03-04 13:30")
## dates in seconds past `start_date`
dates_sec <- c(0, 48, 96, 97, 98) * 3600
## presentation & break times in seconds past the hour
p_times_1 <- seq(5, by = 8, length.out = 5)
break_1 <- 45
p_times_2 <- seq(55, by = 8, length.out = 5)
break_2 <- 95
p_times_3 <- seq(105, by = 8, length.out = 6)
